...
VALUES
    ...
    ('John User', '$2a$10$hqDhRHN1Kn6ad7.n0jrLJ.VweyWmetIka46ukMxx/jRfXPHM9aXMa', 'USER', 'user2@mail.com', true), --password: SuperSecretUser2!
    ('notAnAdmin', '$2a$10$FRv/wwcrkeOelCk666IuleDU2H7g5wd/5lNAFvgCSyFg5r/1LrCc.', 'USER', 'user3@mail.com', true), --password: SuperSecretUser3!
    ('Tesla Dziekana', '$2a$10$SBmLQz/Vj/3uVB2USrX7BemXuMiY2Ei8gAeQ6FpG49xIF4yQYP8.q', 'USER', 'user4@mail.com', true); --password: SuperSecretUser4!
...
VALUES
    ...
    (1, 'Wish', '03a3c760-2891-41bc-963d-bc5466a19b92_cavalry.mp4', FALSE),
